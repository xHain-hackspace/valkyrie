...
config :valkyrie, Valkyrie.Repo,
  database: Path.expand("../valkyrie_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :valkyrie, ValkyrieWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/valkyrie_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :valkyrie, dev_routes: true, token_signing_secret: "0uNCKSOGtKYfxQcJf7o1TU/bKgfp6TT/"
