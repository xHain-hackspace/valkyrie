defmodule ValkyrieWeb.Components.NativeSelect do
  @moduledoc """
  The `ValkyrieWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `ValkyrieWeb.Components.NativeSelect`
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/native-select
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ValkyrieWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ValkyrieWeb.Gettext, "errors", msg, opts)
    end
  end
end
