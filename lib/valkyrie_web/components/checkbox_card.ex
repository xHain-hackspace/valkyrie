defmodule ValkyrieWeb.Components.CheckboxCard do
  @moduledoc """
  The `ValkyrieWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
