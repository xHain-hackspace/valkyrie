defmodule ValkyrieWeb.Components.ScrollArea do
  @moduledoc """
  The `ValkyrieWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
