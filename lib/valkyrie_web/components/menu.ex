defmodule ValkyrieWeb.Components.Menu do
  @moduledoc """
  The `ValkyrieWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `ValkyrieWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import ValkyrieWeb.Components.Button, only: [button_link: 1]
