defmodule ValkyrieWeb.Components.Tabs do
  @moduledoc """
  `ValkyrieWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import ValkyrieWeb.Components.Badge, only: [badge: 1]
